    ...
    <div className="flex justify-center items-center w-full px-4 mt-[30px] lg:mt-[60px]">
      <div className="w-full max-w-[1000px] text-center relative">
        <h1 className="text-[32px] sm:text-[44px] md:text-[56px] lg:text-[66px] leading-[1.2] font-bold font-primary text-[#262525] tracking-tight">
          <span className="block sm:inline">Build New Habits.</span>{" "}
          <span className="inline-flex items-center justify-center gap-2 sm:gap-3 mt-2 lg:mt-3 whitespace-nowrap max-w-full overflow-visible">
            <span>Achieve</span>
            <span className="relative inline-flex items-center px-3 md:px-5 py-1 md:py-1.5 z-10 min-h-[50px] sm:min-h-[60px] md:min-h-[72px] whitespace-nowrap">
