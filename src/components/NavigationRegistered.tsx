      ...
      <div className="gh-shell relative flex h-[110px] items-center justify-between px-[20px] lg:px-[100px]">
        ...
        <div className="hidden lg:flex items-center">
          ...
          >
            <button
              ...
              className="relative w-11 h-11 rounded-full border border-[#eceff7] bg-white flex items-center justify-center text-[#5c657d] hover:text-[#7655fb] hover:bg-[#f3f6ff]/40 shadow-[0_4px_12px_rgba(24,33,77,0.03)] hover:shadow-[0_4px_15px_rgba(118,85,251,0.08)] transition-all duration-300 cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#7655fb]/20"
            >
          ...
          {/* Get Token Button */}
          <Link href="/get-token" className="gh-btn-secondary mr-[30px] h-11 px-5 text-[14px] flex items-center justify-center">
        ...
        <div className="lg:hidden ml-auto flex items-center gap-2">
          ...
          <div className="relative">
            <button
              onClick={() => setNotificationOpen(!notificationOpen)}
              className="relative w-10 h-10 rounded-full border border-[#eceff7] bg-white flex items-center justify-center text-[#5c657d] shadow-[0_4px_12px_rgba(24,33,77,0.03)] cursor-pointer focus:outline-none"
            >
              ...
              {hasUnread && (
                <div className="absolute top-[8px] right-[10px] w-[8px] h-[8px] bg-[#ff4e68] rounded-full ring-2 ring-white animate-pulse"></div>
              )}
            </button>
