...
const DashboardHeader = () => {
  return (
    <div className="flex items-center justify-end w-full py-[27px] px-[50px] bg-[#f4f6fb]">
      <button className="flex items-center justify-center gap-[8px] bg-[#7655fb] rounded-[5px] px-[16px] py-[8px] w-[176px] h-[50px] hover:bg-[#6445e0] transition-colors shadow-lg shadow-[#7655fb]/20">
